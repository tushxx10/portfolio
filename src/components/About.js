                        ...
                        <div className="my-text">
                            <div className="frame">
                                ...
                                <div id="hobbies" className='about-overviews'>
                                    ...
                                    <hr/>
                                    <ul>
                                        <li><span> Enjoy tackling coding problems on platforms like LeetCode, GFG.<span>🏏</span></span>
                                        </li>
                                        <hr/>
                                        <li><span>Passionate about experimenting with new technologies and frameworks in software development.<span> ♔</span></span></li>
                                        <hr />
